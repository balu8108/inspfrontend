...
//   // useEffect(() => {
//   //   async function fetchAllTopicsForSubjectApi() {
//   //     setIsLoadingTopics(true);
//   //     try {
//   //       const response = await fetchAllTopicsForSubjectApi();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!selectedSubject || !selectedTopic) {
        // If subject or topic is not selected, set an error message and return
