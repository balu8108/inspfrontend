...
export const getAllSoloClassRoom = () =>
  API.get(`/solo-lecture/get-all-soloclassrooms`);

export const getSoloClassForTopicBasedRecording = (topicId) =>
  API.get(`/solo-lecture/get-soloclass-for-topicbasedrecording/${topicId}`);
